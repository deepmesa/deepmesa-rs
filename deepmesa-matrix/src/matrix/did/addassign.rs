...
use crate::matrix::did::macros::simd_add_assign;
    ...
    T: MatrixElement + std::ops::AddAssign,
{
    fn add_assign(&mut self, val: T) {
        if self.use_simd() {
            ...
            let len = self.len();
            unsafe {
                SimdKernel::simd_add_assign(ptr, val, len);
            }
    ...
    T: MatrixElement + std::ops::AddAssign,
{
    fn add_assign(&mut self, rhs: &RowMajorDataset<T>) {
        ...
        if self.is_transpose {
            if rhs.is_transpose {
                crate::matrix::rmd::macros::simd_add_assign!(
                    rmd_t,
                    rmd_t,
                    self.rmd,
                    rhs,
                ...
                crate::matrix::cmd::macros::simd_add_assign!(
                    cmd_t,
                    rmd,
                    self.cmd,
                    rhs,
...
//     fn_test_add_assign_val!(test_add_assign_did_val, did);
//     fn_test_add_assign_val!(test_add_assign_did_t_val, did_t);

//     fn_test_add_assign!(test_add_assign_did_rmd, did, rmd);
//     fn_test_add_assign!(test_add_assign_did_cmd, did, cmd);
//     fn_test_add_assign!(test_add_assign_did_did, did, did);
//     fn_test_add_assign!(test_add_assign_did_rmd_t, did, rmd_t);
//     fn_test_add_assign!(test_add_assign_did_cmd_t, did, cmd_t);
//     fn_test_add_assign!(test_add_assign_did_did_t, did, did_t);

//     fn_test_add_assign!(test_add_assign_did_t_rmd, did_t, rmd);
//     fn_test_add_assign!(test_add_assign_did_t_cmd, did_t, cmd);
//     fn_test_add_assign!(test_add_assign_did_t_did, did_t, did);
//     fn_test_add_assign!(test_add_assign_did_t_rmd_t, did_t, rmd_t);
//     fn_test_add_assign!(test_add_assign_did_t_cmd_t, did_t, cmd_t);
//     fn_test_add_assign!(test_add_assign_did_t_did_t, did_t, did_t);

//     fn_test_add_assign_simd_val!(test_add_assign_simd_did_val, did);
//     fn_test_add_assign_simd_val!(test_add_assign_simd_did_t_val, did_t);

//     fn_test_add_assign_simd!(test_add_assign_simd_did_rmd, did, rmd);
//     fn_test_add_assign_simd!(test_add_assign_simd_did_cmd, did, cmd);
//     fn_test_add_assign_simd!(test_add_assign_simd_did_did, did, did);
//     fn_test_add_assign_simd!(test_add_assign_simd_did_rmd_t, did, rmd_t);
//     fn_test_add_assign_simd!(test_add_assign_simd_did_cmd_t, did, cmd_t);
//     fn_test_add_assign_simd!(test_add_assign_simd_did_did_t, did, did_t);

//     fn_test_add_assign_simd!(test_add_assign_simd_did_t_rmd, did_t, rmd);
//     fn_test_add_assign_simd!(test_add_assign_simd_did_t_cmd, did_t, cmd);
//     fn_test_add_assign_simd!(test_add_assign_simd_did_t_did, did_t, did);
//     fn_test_add_assign_simd!(test_add_assign_simd_did_t_rmd_t, did_t, rmd_t);
//     fn_test_add_assign_simd!(test_add_assign_simd_did_t_cmd_t, did_t, cmd_t);
//     fn_test_add_assign_simd!(test_add_assign_simd_did_t_did_t, did_t, did_t);
// }
