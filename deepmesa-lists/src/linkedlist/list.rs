...
impl<T> FastLinkedList<T> {
    ...
    /// Returns a mutable iterator over the list that allows the value to be modified
    /// # Examples
    /// ```
    /// use deepmesa::lists::FastLinkedList;
    /// let mut list = FastLinkedList::<u8>::new();
    ...
    /// Removes and drops all the elements from this list. This
    /// operation takes O(n) time and no memory is deallocated. This
    /// has no effect on the allocated capacity of the list.
    ///
    /// # Examples
    /// ```
    /// use deepmesa::lists::FastLinkedList;
    ...
    /// preceeding node, this method returns None.
    ///
    /// # Examples
    /// ```
    /// use deepmesa::lists::FastLinkedList;
    ...
    /// or if there is no preceeding node, this method returns None.
    ///
    /// # Examples
    /// ```
    /// use deepmesa::lists::FastLinkedList;
