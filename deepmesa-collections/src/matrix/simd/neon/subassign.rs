...
macro_rules! impl_simd_sub_assign {
    ($t:ident) => {
        ...
        impl SimdSubAssign<$t, *const $t> for $t {
...
impl_simd_sub_assign!(u8);
impl_simd_sub_assign!(u16);
impl_simd_sub_assign!(u32);
impl_simd_sub_assign!(i8);
impl_simd_sub_assign!(i16);
impl_simd_sub_assign!(i32);
impl_simd_sub_assign!(f32);
impl_simd_sub_assign!(f64);
