...
macro_rules! vadd_vaddq {
    ...
    (u8, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: uint8x16_t = vaddq_u8($v_lhs.0, $v_rhs);
        let res_1: uint8x16_t = vaddq_u8($v_lhs.1, $v_rhs);
    ...
    (u8, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: uint8x16_t = vaddq_u8($v_lhs.0, $v_rhs);
        let res_1: uint8x16_t = vaddq_u8($v_lhs.1, $v_rhs);
        let res_2: uint8x16_t = vaddq_u8($v_lhs.2, $v_rhs);
    ...
    (u8, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: uint8x16_t = vaddq_u8($v_lhs.1, $v_rhs);
        let res_2: uint8x16_t = vaddq_u8($v_lhs.2, $v_rhs);
        let res_3: uint8x16_t = vaddq_u8($v_lhs.3, $v_rhs);
    ...
    (i8, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: int8x16_t = vaddq_s8($v_lhs.0, $v_rhs);
        let res_1: int8x16_t = vaddq_s8($v_lhs.1, $v_rhs);
    ...
    (i8, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: int8x16_t = vaddq_s8($v_lhs.0, $v_rhs);
        let res_1: int8x16_t = vaddq_s8($v_lhs.1, $v_rhs);
        let res_2: int8x16_t = vaddq_s8($v_lhs.2, $v_rhs);
    ...
    (i8, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: int8x16_t = vaddq_s8($v_lhs.1, $v_rhs);
        let res_2: int8x16_t = vaddq_s8($v_lhs.2, $v_rhs);
        let res_3: int8x16_t = vaddq_s8($v_lhs.3, $v_rhs);
    ...
    (u16, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: uint16x8_t = vaddq_u16($v_lhs.0, $v_rhs);
        let res_1: uint16x8_t = vaddq_u16($v_lhs.1, $v_rhs);
    ...
    (u16, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: uint16x8_t = vaddq_u16($v_lhs.0, $v_rhs);
        let res_1: uint16x8_t = vaddq_u16($v_lhs.1, $v_rhs);
        let res_2: uint16x8_t = vaddq_u16($v_lhs.2, $v_rhs);
    ...
    (u16, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: uint16x8_t = vaddq_u16($v_lhs.1, $v_rhs);
        let res_2: uint16x8_t = vaddq_u16($v_lhs.2, $v_rhs);
        let res_3: uint16x8_t = vaddq_u16($v_lhs.3, $v_rhs);
    ...
    (i16, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: int16x8_t = vaddq_s16($v_lhs.0, $v_rhs);
        let res_1: int16x8_t = vaddq_s16($v_lhs.1, $v_rhs);
    ...
    (i16, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: int16x8_t = vaddq_s16($v_lhs.0, $v_rhs);
        let res_1: int16x8_t = vaddq_s16($v_lhs.1, $v_rhs);
        let res_2: int16x8_t = vaddq_s16($v_lhs.2, $v_rhs);
    ...
    (i16, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: int16x8_t = vaddq_s16($v_lhs.1, $v_rhs);
        let res_2: int16x8_t = vaddq_s16($v_lhs.2, $v_rhs);
        let res_3: int16x8_t = vaddq_s16($v_lhs.3, $v_rhs);
    ...
    (u32, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: uint32x4_t = vaddq_u32($v_lhs.0, $v_rhs);
        let res_1: uint32x4_t = vaddq_u32($v_lhs.1, $v_rhs);
    ...
    (u32, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: uint32x4_t = vaddq_u32($v_lhs.0, $v_rhs);
        let res_1: uint32x4_t = vaddq_u32($v_lhs.1, $v_rhs);
        let res_2: uint32x4_t = vaddq_u32($v_lhs.2, $v_rhs);
    ...
    (u32, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: uint32x4_t = vaddq_u32($v_lhs.1, $v_rhs);
        let res_2: uint32x4_t = vaddq_u32($v_lhs.2, $v_rhs);
        let res_3: uint32x4_t = vaddq_u32($v_lhs.3, $v_rhs);
    ...
    (i32, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: int32x4_t = vaddq_s32($v_lhs.0, $v_rhs);
        let res_1: int32x4_t = vaddq_s32($v_lhs.1, $v_rhs);
    ...
    (i32, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: int32x4_t = vaddq_s32($v_lhs.0, $v_rhs);
        let res_1: int32x4_t = vaddq_s32($v_lhs.1, $v_rhs);
        let res_2: int32x4_t = vaddq_s32($v_lhs.2, $v_rhs);
    ...
    (i32, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: int32x4_t = vaddq_s32($v_lhs.1, $v_rhs);
        let res_2: int32x4_t = vaddq_s32($v_lhs.2, $v_rhs);
        let res_3: int32x4_t = vaddq_s32($v_lhs.3, $v_rhs);
    ...
    (f32, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: float32x4_t = vaddq_f32($v_lhs.0, $v_rhs);
        let res_1: float32x4_t = vaddq_f32($v_lhs.1, $v_rhs);
    ...
    (f32, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: float32x4_t = vaddq_f32($v_lhs.0, $v_rhs);
        let res_1: float32x4_t = vaddq_f32($v_lhs.1, $v_rhs);
        let res_2: float32x4_t = vaddq_f32($v_lhs.2, $v_rhs);
    ...
    (f32, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: float32x4_t = vaddq_f32($v_lhs.1, $v_rhs);
        let res_2: float32x4_t = vaddq_f32($v_lhs.2, $v_rhs);
        let res_3: float32x4_t = vaddq_f32($v_lhs.3, $v_rhs);
    ...
    (f64, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: float64x2_t = vaddq_f64($v_lhs.0, $v_rhs);
        let res_1: float64x2_t = vaddq_f64($v_lhs.1, $v_rhs);
    ...
    (f64, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: float64x2_t = vaddq_f64($v_lhs.0, $v_rhs);
        let res_1: float64x2_t = vaddq_f64($v_lhs.1, $v_rhs);
        let res_2: float64x2_t = vaddq_f64($v_lhs.2, $v_rhs);
    ...
    (f64, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: float64x2_t = vaddq_f64($v_lhs.1, $v_rhs);
        let res_2: float64x2_t = vaddq_f64($v_lhs.2, $v_rhs);
        let res_3: float64x2_t = vaddq_f64($v_lhs.3, $v_rhs);
...
#[cfg(all(target_arch = "aarch64", target_feature = "neon"))]
pub(in crate::matrix::simd) use vadd_vaddq;
