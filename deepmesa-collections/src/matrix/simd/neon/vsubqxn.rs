...
#[rustfmt::skip]
macro_rules! vsub_vsubqxn {
    (u8, x1, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let $v_res: uint8x16_t = vsubq_u8($v_lhs, $v_rhs);
    };
    (u8, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: uint8x16_t = vsubq_u8($v_lhs.0, $v_rhs.0);
        let res_1: uint8x16_t = vsubq_u8($v_lhs.1, $v_rhs.1);
    ...
    (u8, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: uint8x16_t = vsubq_u8($v_lhs.0, $v_rhs.0);
        let res_1: uint8x16_t = vsubq_u8($v_lhs.1, $v_rhs.1);
        let res_2: uint8x16_t = vsubq_u8($v_lhs.2, $v_rhs.2);
    ...
    (u8, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: uint8x16_t = vsubq_u8($v_lhs.1, $v_rhs.1);
        let res_2: uint8x16_t = vsubq_u8($v_lhs.2, $v_rhs.2);
        let res_3: uint8x16_t = vsubq_u8($v_lhs.3, $v_rhs.3);
    ...
    (i8, x1, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let $v_res: int8x16_t = vsubq_s8($v_lhs, $v_rhs);
    };
    (i8, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: int8x16_t = vsubq_s8($v_lhs.0, $v_rhs.0);
        let res_1: int8x16_t = vsubq_s8($v_lhs.1, $v_rhs.1);
    ...
    (i8, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: int8x16_t = vsubq_s8($v_lhs.0, $v_rhs.0);
        let res_1: int8x16_t = vsubq_s8($v_lhs.1, $v_rhs.1);
        let res_2: int8x16_t = vsubq_s8($v_lhs.2, $v_rhs.2);
    ...
    (i8, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: int8x16_t = vsubq_s8($v_lhs.1, $v_rhs.1);
        let res_2: int8x16_t = vsubq_s8($v_lhs.2, $v_rhs.2);
        let res_3: int8x16_t = vsubq_s8($v_lhs.3, $v_rhs.3);
    ...
    (u16, x1, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let $v_res: uint16x8_t = vsubq_u16($v_lhs, $v_rhs);
    };
    (u16, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: uint16x8_t = vsubq_u16($v_lhs.0, $v_rhs.0);
        let res_1: uint16x8_t = vsubq_u16($v_lhs.1, $v_rhs.1);
    ...
    (u16, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: uint16x8_t = vsubq_u16($v_lhs.0, $v_rhs.0);
        let res_1: uint16x8_t = vsubq_u16($v_lhs.1, $v_rhs.1);
        let res_2: uint16x8_t = vsubq_u16($v_lhs.2, $v_rhs.2);
    ...
    (u16, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: uint16x8_t = vsubq_u16($v_lhs.1, $v_rhs.1);
        let res_2: uint16x8_t = vsubq_u16($v_lhs.2, $v_rhs.2);
        let res_3: uint16x8_t = vsubq_u16($v_lhs.3, $v_rhs.3);
    ...
    (i16, x1, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let $v_res: int16x8_t = vsubq_s16($v_lhs, $v_rhs);
    };
    (i16, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: int16x8_t = vsubq_s16($v_lhs.0, $v_rhs.0);
        let res_1: int16x8_t = vsubq_s16($v_lhs.1, $v_rhs.1);
    ...
    (i16, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: int16x8_t = vsubq_s16($v_lhs.0, $v_rhs.0);
        let res_1: int16x8_t = vsubq_s16($v_lhs.1, $v_rhs.1);
        let res_2: int16x8_t = vsubq_s16($v_lhs.2, $v_rhs.2);
    ...
    (i16, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: int16x8_t = vsubq_s16($v_lhs.1, $v_rhs.1);
        let res_2: int16x8_t = vsubq_s16($v_lhs.2, $v_rhs.2);
        let res_3: int16x8_t = vsubq_s16($v_lhs.3, $v_rhs.3);
    ...
    (u32, x1, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let $v_res: uint32x4_t = vsubq_u32($v_lhs, $v_rhs);
    };
    (u32, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: uint32x4_t = vsubq_u32($v_lhs.0, $v_rhs.0);
        let res_1: uint32x4_t = vsubq_u32($v_lhs.1, $v_rhs.1);
    ...
    (u32, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: uint32x4_t = vsubq_u32($v_lhs.0, $v_rhs.0);
        let res_1: uint32x4_t = vsubq_u32($v_lhs.1, $v_rhs.1);
        let res_2: uint32x4_t = vsubq_u32($v_lhs.2, $v_rhs.2);
    ...
    (u32, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: uint32x4_t = vsubq_u32($v_lhs.1, $v_rhs.1);
        let res_2: uint32x4_t = vsubq_u32($v_lhs.2, $v_rhs.2);
        let res_3: uint32x4_t = vsubq_u32($v_lhs.3, $v_rhs.3);
    ...
    (i32, x1, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let $v_res: int32x4_t = vsubq_s32($v_lhs, $v_rhs);
    };
    (i32, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: int32x4_t = vsubq_s32($v_lhs.0, $v_rhs.0);
        let res_1: int32x4_t = vsubq_s32($v_lhs.1, $v_rhs.1);
    ...
    (i32, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: int32x4_t = vsubq_s32($v_lhs.0, $v_rhs.0);
        let res_1: int32x4_t = vsubq_s32($v_lhs.1, $v_rhs.1);
        let res_2: int32x4_t = vsubq_s32($v_lhs.2, $v_rhs.2);
    ...
    (i32, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: int32x4_t = vsubq_s32($v_lhs.1, $v_rhs.1);
        let res_2: int32x4_t = vsubq_s32($v_lhs.2, $v_rhs.2);
        let res_3: int32x4_t = vsubq_s32($v_lhs.3, $v_rhs.3);
    ...
    (f32, x1, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let $v_res: float32x4_t = vsubq_f32($v_lhs, $v_rhs);
    };
    (f32, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: float32x4_t = vsubq_f32($v_lhs.0, $v_rhs.0);
        let res_1: float32x4_t = vsubq_f32($v_lhs.1, $v_rhs.1);
    ...
    (f32, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: float32x4_t = vsubq_f32($v_lhs.0, $v_rhs.0);
        let res_1: float32x4_t = vsubq_f32($v_lhs.1, $v_rhs.1);
        let res_2: float32x4_t = vsubq_f32($v_lhs.2, $v_rhs.2);
    ...
    (f32, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: float32x4_t = vsubq_f32($v_lhs.1, $v_rhs.1);
        let res_2: float32x4_t = vsubq_f32($v_lhs.2, $v_rhs.2);
        let res_3: float32x4_t = vsubq_f32($v_lhs.3, $v_rhs.3);
    ...
    (f64, x1, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let $v_res: float64x2_t = vsubq_f64($v_lhs, $v_rhs);
    };
    (f64, x2, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: float64x2_t = vsubq_f64($v_lhs.0, $v_rhs.0);
        let res_1: float64x2_t = vsubq_f64($v_lhs.1, $v_rhs.1);
    ...
    (f64, x3, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        let res_0: float64x2_t = vsubq_f64($v_lhs.0, $v_rhs.0);
        let res_1: float64x2_t = vsubq_f64($v_lhs.1, $v_rhs.1);
        let res_2: float64x2_t = vsubq_f64($v_lhs.2, $v_rhs.2);
    ...
    (f64, x4, $v_lhs:ident, $v_rhs:ident, $v_res:ident) => {
        ...
        let res_1: float64x2_t = vsubq_f64($v_lhs.1, $v_rhs.1);
        let res_2: float64x2_t = vsubq_f64($v_lhs.2, $v_rhs.2);
        let res_3: float64x2_t = vsubq_f64($v_lhs.3, $v_rhs.3);
...
#[cfg(all(target_arch = "aarch64", target_feature = "neon"))]
pub(in crate::matrix::simd) use vsub_vsubqxn;
