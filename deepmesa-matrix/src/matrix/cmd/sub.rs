...
impl<T> Sub<T> for ColMajorDataset<T>
where
    T: MatrixElement + std::ops::SubAssign + std::ops::Sub<Output = T>,
{
    type Output = ColMajorDataset<T>;
    fn sub(mut self, rhs: T) -> ColMajorDataset<T> {
        self.sub_assign(rhs);
        return self;
    }
}

impl<T> Sub<&RowMajorDataset<T>> for ColMajorDataset<T>
where
    T: MatrixElement + std::ops::SubAssign + std::ops::Sub<Output = T>,
{
    type Output = ColMajorDataset<T>;
    fn sub(mut self, rhs: &RowMajorDataset<T>) -> ColMajorDataset<T> {
        self.sub_assign(rhs);
        return self;
    }
}

impl<T> Sub<&ColMajorDataset<T>> for ColMajorDataset<T>
where
    T: MatrixElement + std::ops::SubAssign + std::ops::Sub<Output = T>,
{
    type Output = ColMajorDataset<T>;
    fn sub(mut self, rhs: &ColMajorDataset<T>) -> ColMajorDataset<T> {
        self.sub_assign(rhs);
        return self;
    }
}

impl<T> Sub<&DualIndexDataset<T>> for ColMajorDataset<T>
where
    T: MatrixElement + std::ops::SubAssign + std::ops::Sub<Output = T>,
{
    type Output = ColMajorDataset<T>;
    fn sub(mut self, rhs: &DualIndexDataset<T>) -> ColMajorDataset<T> {
        self.sub_assign(rhs);
        return self;
    }
}
...
{
    type Output = ColMajorDataset<T>;
    fn sub(self, rhs: T) -> ColMajorDataset<T> {
...
{
    type Output = ColMajorDataset<T>;
    fn sub(self, rhs: &RowMajorDataset<T>) -> ColMajorDataset<T> {
        let mut result = ColMajorDataset::from(&self);
        self.sub_into(rhs, &mut result);
        return result;
    }
...
{
    type Output = ColMajorDataset<T>;
    fn sub(self, rhs: &ColMajorDataset<T>) -> ColMajorDataset<T> {
        let mut result = ColMajorDataset::from(&self);
        self.sub_into(rhs, &mut result);
        return result;
    }
...
{
    type Output = ColMajorDataset<T>;
    fn sub(self, rhs: &DualIndexDataset<T>) -> ColMajorDataset<T> {
        let mut result = ColMajorDataset::from(&self);
        self.sub_into(rhs, &mut result);
        return result;
    }
...
//     fn_test_sub_val!(test_sub_val_rmd, cmd);
//     fn_test_sub_val!(test_sub_val_rmd_t, cmd_t);

//     fn_test_sub_val_simd!(test_sub_simd_val_rmd, cmd);
//     fn_test_sub_val_simd!(test_sub_simd_val_rmd_t, cmd_t);

//     fn_test_sub!(test_sub_cmd_rmd, cmd, rmd);
//     fn_test_sub!(test_sub_cmd_cmd, cmd, cmd);
//     fn_test_sub!(test_sub_cmd_did, cmd, did);

//     fn_test_sub!(test_sub_cmd_rmd_t, cmd, rmd_t);
//     fn_test_sub!(test_sub_cmd_cmd_t, cmd, cmd_t);
//     fn_test_sub!(test_sub_cmd_did_t, cmd, did_t);

//     fn_test_sub!(test_sub_cmd_t_rmd, cmd_t, rmd);
//     fn_test_sub!(test_sub_cmd_t_cmd, cmd_t, cmd);
//     fn_test_sub!(test_sub_cmd_t_did, cmd_t, did);

//     fn_test_sub!(test_sub_cmd_t_rmd_t, cmd_t, rmd_t);
//     fn_test_sub!(test_sub_cmd_t_cmd_t, cmd_t, cmd_t);
//     fn_test_sub!(test_sub_cmd_t_did_t, cmd_t, did_t);

//     fn_test_sub_simd!(test_sub_simd_cmd_rmd, cmd, rmd);
//     fn_test_sub_simd!(test_sub_simd_cmd_cmd, cmd, cmd);
//     fn_test_sub_simd!(test_sub_simd_cmd_did, cmd, did);

//     fn_test_sub_simd!(test_sub_simd_cmd_rmd_t, cmd, rmd_t);
//     fn_test_sub_simd!(test_sub_simd_cmd_cmd_t, cmd, cmd_t);
//     fn_test_sub_simd!(test_sub_simd_cmd_did_t, cmd, did_t);

//     fn_test_sub_simd!(test_sub_simd_cmd_t_rmd, cmd_t, rmd);
//     fn_test_sub_simd!(test_sub_simd_cmd_t_cmd, cmd_t, cmd);
//     fn_test_sub_simd!(test_sub_simd_cmd_t_did, cmd_t, did);

//     fn_test_sub_simd!(test_sub_simd_cmd_t_rmd_t, cmd_t, rmd_t);
//     fn_test_sub_simd!(test_sub_simd_cmd_t_cmd_t, cmd_t, cmd_t);
//     fn_test_sub_simd!(test_sub_simd_cmd_t_did_t, cmd_t, did_t);
// }
