...
macro_rules! impl_simd_mul_into {
    ($t:ident) => {
        ...
        impl SimdMulInto<$t, *const $t> for $t {
...
impl_simd_mul_into!(u8);
impl_simd_mul_into!(u16);
impl_simd_mul_into!(u32);
impl_simd_mul_into!(i8);
impl_simd_mul_into!(i16);
impl_simd_mul_into!(i32);
impl_simd_mul_into!(f32);
impl_simd_mul_into!(f64);
